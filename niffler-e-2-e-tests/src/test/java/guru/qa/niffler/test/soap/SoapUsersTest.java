...
public class SoapUsersTest {
    ...
    void getAllFriendsTest(UserJson userJson) throws IOException {
    ...
    @Test
    @User(amountOfFriends = 2)
    void getAllFriendsByUsernameTest(UserJson userJson) throws IOException {
    ...
    void sendInvitationTest(UserJson userJson) throws IOException {
        String friendToBeRequestedUsername = "Duck";
